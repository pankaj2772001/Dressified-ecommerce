            ...
            <div className="col-md-6 py-3" >
...

                {
                    ...
                    address.length > 0 ? address?.map(add => (
                        <div key={add._id} className="border px-5 py-3 shadow-sm mb-4 rounded">
                            ...
                            <div className="d-flex gap-2">
                                ...
                                <button className="btn btn-primary w-50" onClick={() => deleteAddress(add._id)}>Delete Address</button>
